...
$(BUILD)/chroot.tag:
	...
	# Remove legacy apt keyring files that trigger apt-key
	# These are created by debootstrap but cause apt-key to be called
	# which fails in containerized environments
	rm -rf "$(BUILD)/chroot/etc/apt/trusted.gpg.d"
