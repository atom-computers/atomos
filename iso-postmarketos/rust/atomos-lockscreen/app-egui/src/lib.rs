...
impl eframe::App for LockscreenApp {
    fn update(&mut self, ctx: &egui::Context, _frame: &mut eframe::Frame) {
        if self.unlocked {
            egui::Area::new(egui::Id::new("lockscreen_area_unlock")).order(egui::Order::Foreground).show(ctx, |ui| {
        ...
        egui::Area::new(egui::Id::new("lockscreen_area")).order(egui::Order::Foreground).show(ctx, |ui| {
